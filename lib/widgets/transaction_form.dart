...
class TransactionForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // if (isEditMode == true && transaction != null) {
    //   // Si estamos en modo edición, inicializamos los campos con los datos existentes
    //   titleController.text = transaction!.title;
    //   amountController.text = transaction!.monto.toStringAsFixed(2);
